...
each corresponding to a different year from 2018 to 2022. The script fetches and prints records based on the 
'stratificationcategory1' field for the categories 'Overall', 'Age', 'Sex', and 'Race/Ethnicity' for each year.
